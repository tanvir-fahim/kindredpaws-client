        ...
        <nav className="sticky top-0 z-40 w-full border-b border-gray-200 bg-white/70 backdrop-blur-lg">
            <header className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
                ...
                <ul className="hidden sm:flex items-center gap-6 font-medium text-gray-700">
                    ...
                    <li>
                        <Link href="/pets" className="hover:text-blue-600 transition-colors">All Pets</Link>
                    </li>

                    {user && (
                        <>
                            <li>
                                <Link href="/my-requests" className="hover:text-blue-600 transition-colors">My Requests</Link>
                            </li>
                            <li>
                                <Link href="/add-pet" className="hover:text-blue-600 transition-colors">Add Pet</Link>
                            </li>
                        </>
                    )}
                </ul>
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                    {user ? (
                        ...
                        <>
                            <Link
                                href="/login"
                                className="px-3 py-2 text-sm sm:text-base text-gray-700 hover:text-blue-600 font-medium transition-colors"
                            >
                                Login
                            </Link>
                            <Link
            ...
            {isMobileMenuOpen && (
                <div className="sm:hidden border-t border-gray-200 bg-white px-6 py-4 space-y-1 shadow-inner animate-fade-in">
                    <Link
                        href="/"
                        className="block py-2.5 font-medium text-gray-700 hover:text-blue-600 transition-colors"
